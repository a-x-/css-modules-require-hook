...
var LocalByDefault = require('postcss-icss-selectors');
...
module.exports = function setupHook(_ref) {
  ...
  var plugins = use || [].concat(prepend, [Values, new LocalByDefault({ mode, generateScopedName: scopedName }), createImportedName ? new ExtractImports({ createImportedName }) : ExtractImports, new Scope({ generateScopedName: scopedName }), new ResolveImports({ resolve: Object.assign({}, { extensions: exts }, resolveOpts) })], append);
